...
void Credits::ini(QHBoxLayout* layout)
{
  ...
  QLabel* text = new QLabel(
    QStringLiteral("<h1>This project</h1>"
                   ...
                   "<p>The developpement started on 2nd, november 2020 and is avaible on <a href=\"https://github.com/Wizer21/Swich\" style=\"color:#d64b4b\">GitHub</a></p>"
                   "<p>This project was only made through C++ with the Qt library.</p>"
                   "<p>I realized the logo on Photoshop.</p></p>"
                   "<p>Faces pictures come from the deep learning generator <a href=\"https://thispersondoesnotexist.com\" style=\"color:#d64b4b\">ThisPersonDoesNotExist</a></p>"
